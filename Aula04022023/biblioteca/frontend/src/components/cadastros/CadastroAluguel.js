...
function CadastroAluguel(props) {
  ...
  async function getLivros() {
    await api.get("/livrosDisponiveis").then((response) => {
  ...
  return (
    <table width="80%" align="center"><tbody><tr><td><br/>
      <h1>{props.estahEmEdicao() ? "Devolução de livro" : "Novo aluguel"}</h1>
      <Col sm="5">
        <Form.Select
          name="idCliente"
